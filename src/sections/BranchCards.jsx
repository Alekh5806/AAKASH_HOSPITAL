...
export default function BranchCards({ branches, showMaps = false }) {
  ...
  return (
    <section
      className={`section branch-section ${showMaps ? "branch-section--maps" : "branch-section--home"}`}
    >
      <div className="container branch-locator">
        <div className="branch-locator__top">
          <div className="section-heading">
            ...
            <p>
              Choose a branch, view the right contact numbers and start booking without leaving the
              page.
            </p>
          </div>
        ...
        {selectedBranch ? (
          ...
          >
            ...
            <div className="branch-showcase__map">
              <LazyMapFrame title={`${selectedBranch.name} map`} src={selectedBranch.mapEmbed} />
        ...
        {showMaps ? (
          <motion.div
            className="branch-grid branch-grid--maps"
          ...
          >
            {branches.map((branch) => (
              ...
              >
                ...
                <button
                  className="branch-card__details"
                  type="button"
                  onClick={() => setSelectedSlug(branch.slug)}
                >
